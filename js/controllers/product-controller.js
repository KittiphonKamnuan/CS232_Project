...
class CompleteProductController {
 constructor() {
   ...
   this.statusOptions = [
     ...
     { value: 'กำลังดำเนินการ', label: 'สถานะ 2: กำลังดำเนินการ' },
     { value: 'รอชำระเงิน', label: 'สถานะ 3: รอชำระเงิน' },
     { value: 'ชำระเงินแล้ว', label: 'สถานะ 4: ชำระเงินแล้ว' },
     { value: 'ส่งมอบสินค้า', label: 'สถานะ 5: ส่งมอบสินค้า' },
     { value: 'บริการหลังการขาย', label: 'สถานะ 6: บริการหลังการขาย' }
   ];
